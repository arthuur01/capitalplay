...
export default function UsdMonthChange() {
...
function TradingViewWidget() {
  useEffect(() => {
    ...
    const container = document.getElementById("tradingview-usd-widget")
  ...
  return <div id="tradingview-usd-widget" className="h-full w-full rounded-lg overflow-hidden" />
}
